...
<s:form>
    ...
    <s:select name="publication.type" headerKey="-1" headerValue="Select..."
              list="publicationTypeList" listValue="title"
    ...
    <s:select name="publication.keywords" headerKey="-1" headerValue="Select..."
              list="keywordList" listValue="word" key="label.keywordText" requiredLabel="true"/>
